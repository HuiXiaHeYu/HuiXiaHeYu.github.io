...
```BASH
sudo pkill -f frpc    # 杀死当前frps进程
sudo nohup ./frpc -c ./frpc.toml &       #指令没错，&符号代表来后台运行
```

当前已映射到公网：

```
ssh -oPort=6068 spa@183.87.40.30	# ssh
http://183.87.40.30:8080/ui/chat/79dcbcfab405b749	# ollama本地部署模型
